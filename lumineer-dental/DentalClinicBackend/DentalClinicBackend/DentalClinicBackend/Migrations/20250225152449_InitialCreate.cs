        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TakingMedications = table.Column<bool>(type: "boolean", nullable: false),
                    Medications = table.Column<string>(type: "text", nullable: true),
                    HasDentalHistory = table.Column<bool>(type: "boolean", nullable: false),
                    DentalHistory = table.Column<string>(type: "text", nullable: true),
                    HasSurgeries = table.Column<bool>(type: "boolean", nullable: false),
                    Surgeries = table.Column<string>(type: "text", nullable: true),
                    HasAdditionalConcerns = table.Column<bool>(type: "boolean", nullable: false),
                    AdditionalConcerns = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
